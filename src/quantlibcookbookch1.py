...
print("Business days between {0} and {1} (US calendar): {2}".format(
    date, us_date, us_busdays))
print("Business days between {0} and {1} (Italy calendar): {2}".format(
    date, italy_date, italy_busdays))
...
print("Business days between {0} and {1} (joint calendar): {2}".format(
    date, joint_date, joint_busdays))
...
schedule = ql.Schedule(effective_date, termination_date, ternor, calendar,
                       business_convention, termination_business_convention, date_generation, end_of_month)
...
interest_rate = ql.InterestRate(
    annual_rate, day_count, compound_type, frequency)
...
new_interest_rate = interest_rate.equivalentRate(
    compound_type, new_freqency, t)
